...
volatile signed long shift = 0 , cnt = 0;
...
void draw(int shift){
  ...
  Nokia5110_PrintBMP(0, ENEMY10H + shift, SmallEnemy10PointA, 0);
  Nokia5110_PrintBMP(16, ENEMY10H + shift, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(32, ENEMY10H + shift, SmallEnemy20PointA, 0);
  Nokia5110_PrintBMP(48, ENEMY10H + shift, SmallEnemy30PointA, 0);
  Nokia5110_PrintBMP(64, ENEMY10H + shift, SmallEnemy30PointA, 0);
  Nokia5110_DisplayBuffer();     // draw buffer
}
void goDown(int delay) {
	while(shift < 40) {
		draw(shift);
		shift = shift+5;
		Delay100ms(delay);
